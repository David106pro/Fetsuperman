...
def create_default_config():
    ...
    return {
        ...
        "delete_horizontal_path": os.path.join(get_desktop_path(), "横图"),
        "delete_vertical_path": os.path.join(get_desktop_path(), "竖图"),
...
def create_project_structure():
    ...
    try:
        ...
        if os.path.exists("main.py"):
            ...
            print_status("主程序文件已复制: poster_downloader.py", "SUCCESS")
        else:
            print_status("未找到main.py文件", "WARNING")
